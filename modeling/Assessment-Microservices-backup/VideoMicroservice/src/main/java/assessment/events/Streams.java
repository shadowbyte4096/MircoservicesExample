...
public class Streams {
	...
	@Singleton
	public KStream<WindowedIdentifier, Long> dummyStream0(ConfiguredStreamBuilder builder) {
		...
		KStream<Long, Object> objectStream = builder
			.stream("DummyProducer0", Consumed.with(Serdes.Long(), serdeRegistry.getSerde(Object.class)));
