...
public class ReactionsController {
	...
	@Get("/{videoId}/{userId}")
	public ReactionDTO GetReaction(long videoId, long userId) {
		return null;
	}
	
	@Put("/{videoId}/{userId}")
	public HttpResponse<Void> UpdateReaction(long videoId, long userId, @Body ReactionDTO details) {
		return null;
	}
	
	@Post("/{videoId}/{userId}")
	public HttpResponse<Void> AddReaction(long videoId, long userId, @Body ReactionDTO details) {
		return null;
	}
}