...
public class Streams {
	...
	@Singleton
	public KStream<WindowedIdentifier, Long> dummyStream1(ConfiguredStreamBuilder builder) {
		...
		KStream<Long, Object> objectStream = builder
			.stream("DummyProducer1", Consumed.with(Serdes.Long(), serdeRegistry.getSerde(Object.class)));
